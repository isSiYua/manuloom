<p align="center">
  <img src="docs/assets/manuloom-hero.jpg" alt="ManuLoom 将视频、音频、网页和图片证据编织成结构化文稿" width="100%">
</p>
...
<p align="center">
  ...
  <a href="README.md"><img alt="English" src="https://img.shields.io/badge/docs-English-8b5cf6.svg"></a>
</p>
...
**[English](README.md) · [完整示例笔记](examples/synthetic-pipeline-note/manuloom-demo.md) · [部署文档](DEPLOYMENT.md) · [配置说明](references/configuration.md)**
