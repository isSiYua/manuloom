...
把 Bilibili、YouTube 公共视频和普通公开网页整理成适合 Obsidian 的“有结构、有细节、有证据”的完整编辑文字稿，而不是简短摘要、原始 ASR 字幕或网页复制粘贴；更多图文与短视频来源通过同一适配器协议接入。
...
当前版本同时包含文字黄金质量回归、任务管理、Bilibili、YouTube 与普通网页来源适配、网页安全边界、动态视觉规划、多图插入、OCR 替换、1080p 定点重截和清理测试。
