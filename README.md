...
把 Bilibili、YouTube、抖音公共视频、知乎回答/文章和普通公开网页整理成适合 Obsidian 的“有结构、有细节、有证据”的完整编辑文字稿，而不是简短摘要、原始 ASR 字幕或网页复制粘贴；更多图文与短视频来源通过同一适配器协议接入。
...
当前版本同时包含文字黄金质量回归、任务管理、Bilibili、YouTube、抖音、知乎与普通网页来源适配、网页安全边界、动态视觉规划、多图插入、OCR 替换、1080p 定点重截和清理测试。
...
- 小红书：下一阶段处理可公开访问的图文笔记链接，但动态页面和平台风控会影响成功率。
