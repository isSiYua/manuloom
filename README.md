...
把 Bilibili 和 YouTube 公共视频整理成适合 Obsidian 的“有结构、有细节、有证据”的完整编辑文字稿，而不是简短摘要或原始 ASR 字幕；更多图文与短视频来源通过同一适配器协议接入。
...
当前版本同时包含文字黄金质量回归、任务管理、Bilibili 与 YouTube 来源适配、动态视觉规划、多图插入、OCR 替换、1080p 定点重截和清理测试。
